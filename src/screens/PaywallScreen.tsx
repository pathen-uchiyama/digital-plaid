            ...
            <ScrollView style={{ paddingHorizontal: 30, marginTop: -20, paddingTop: 40 }} showsVerticalScrollIndicator={false}>
                ...
                {currentTier === 'explorer' && (
                    <View style={{ backgroundColor: '#FFF', borderRadius: 30, padding: 24, marginBottom: 24, shadowColor: '#000', shadowOffset: { width: 0, height: 10 }, shadowOpacity: 0.05, shadowRadius: 20, elevation: 5, borderWidth: 1, borderColor: 'rgba(212, 175, 55, 0.2)' }}>
                        <Text style={{ color: '#12232E', fontSize: 18, fontFamily: 'Georgia', marginBottom: 8 }}>Intelligent Blueprint</Text>
                        ...
                        <Text style={{ color: '#12232E88', fontSize: 11, marginBottom: 20 }}>A full week (7-days) of elite experience support with the convenience of in-app activation. Handles reservation finding and real-time itinerary adjustments directly from your mobile device.</Text>

                        {renderFeature('Gemini 1.5 Pro Persistent Memory')}
                        {renderFeature('Unlimited Multi-Day & Multi-Park Iterations')}
                        {renderFeature('Deep RAG Disney Lore & Context')}
                        {renderFeature('6:45 AM Daily "Sitrep"')}
                        {renderFeature('Unlimited Dining Availability Alerts')}

                        <TouchableOpacity style={{ backgroundColor: '#12232E', paddingVertical: 14, borderRadius: 15, alignItems: 'center', marginTop: 10 }}>
                            <Text style={{ color: '#FFF', fontSize: 12, fontWeight: '800', textTransform: 'uppercase', letterSpacing: 2 }}>Subscribe Annually</Text>
                        </TouchableOpacity>
                    </View>
                )}
                ...
                <View style={{ backgroundColor: '#12232E', borderRadius: 30, padding: 24, marginBottom: 100, shadowColor: '#D4AF37', shadowOffset: { width: 0, height: 10 }, shadowOpacity: 0.2, shadowRadius: 20, elevation: 10, borderWidth: 2, borderColor: '#D4AF37' }}>
                    <View style={{ position: 'absolute', top: -12, right: 24, backgroundColor: '#D4AF37', paddingHorizontal: 12, paddingVertical: 4, borderRadius: 10 }}>
                        <Text style={{ color: '#12232E', fontSize: 9, fontWeight: '900', textTransform: 'uppercase', letterSpacing: 2 }}>Ultimate Authorization</Text>
                    </View>

                    <Text style={{ color: '#FFF', fontSize: 18, fontFamily: 'Georgia', marginBottom: 8, marginTop: 10 }}>The Active Automation</Text>
                    ...
                    <View style={{ flexDirection: 'row', gap: 12, marginBottom: 16, justifyContent: 'space-between', marginTop: 8 }}>
                        <View style={{ flex: 1, backgroundColor: 'rgba(255,255,255,0.05)', padding: 12, borderRadius: 15, borderWidth: 1, borderColor: 'rgba(255,255,255,0.1)' }}>
                            <Text style={{ color: '#FFF', fontSize: 18, fontWeight: '800' }}>$35.00 <Text style={{ fontSize: 10, fontWeight: '400', color: '#FFFFFF66' }}>/ Day</Text></Text>
                            <Text style={{ color: 'rgba(255,255,255,0.4)', fontSize: 7, textTransform: 'uppercase', marginTop: 4 }}>Daily Pass - App Rate</Text>
                            <TouchableOpacity style={{ backgroundColor: '#FFF', paddingVertical: 10, borderRadius: 10, alignItems: 'center', marginTop: 12 }}>
                                <Text style={{ color: '#12232E', fontSize: 10, fontWeight: '800', textTransform: 'uppercase', letterSpacing: 1 }}>Add to Day</Text>
                            </TouchableOpacity>
                        </View>
                        <View style={{ flex: 1, backgroundColor: 'rgba(212,175,55,0.1)', padding: 12, borderRadius: 15, borderWidth: 1, borderColor: 'rgba(212,175,55,0.3)' }}>
                            <View style={{ position: 'absolute', top: -8, right: 8, backgroundColor: '#D4AF37', paddingHorizontal: 6, paddingVertical: 2, borderRadius: 6 }}>
                                <Text style={{ color: '#12232E', fontSize: 7, fontWeight: '900', textTransform: 'uppercase' }}>Most Seamless</Text>
                            </View>
                            <Text style={{ color: '#D4AF37', fontSize: 18, fontWeight: '800' }}>$59.99 <Text style={{ fontSize: 10, fontWeight: '400', color: '#D4AF3766' }}>/ Week</Text></Text>
                            <Text style={{ color: '#D4AF3788', fontSize: 7, textTransform: 'uppercase', marginTop: 4 }}>Weekly Pass - App Rate</Text>
                            <TouchableOpacity style={{ backgroundColor: '#D4AF37', paddingVertical: 10, borderRadius: 10, alignItems: 'center', marginTop: 12 }}>
                                <Text style={{ color: '#12232E', fontSize: 10, fontWeight: '800', textTransform: 'uppercase', letterSpacing: 1 }}>Activate via App Store</Text>
                            </TouchableOpacity>
                        </View>
                    </View>
                    ...
                    <TouchableOpacity style={{ marginBottom: 24, alignItems: 'center' }}>
                        <Text style={{ color: '#D4AF37', fontSize: 10, fontFamily: 'Georgia', fontStyle: 'italic', textAlign: 'center' }}>
                            Looking for your Member Portal discount? Log in to your account at castlecompanion.com to apply your existing credits or secure direct-member pricing ($39.99).
                        </Text>
                    </TouchableOpacity>

                    <Text style={{ color: '#FFF', opacity: 0.7, fontSize: 11, marginBottom: 24, lineHeight: 16 }}>The elite expert concierge. Deploys a personal booking system to handle reservations while your Guide performs real-time updates as conditions shift.</Text>

                    {renderFeature('Hybrid Core: Pro Strategy + Flash Execution', true)}
                    {renderFeature('Real-Time "In-Park" AI Pivots (Weather, Breaking)', true)}
